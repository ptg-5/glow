...
class GStreamerYoloApp(GStreamerApp):
    def __init__(self, app_callback, user_data, parser=None):
        ...
        self.hef_path = "/home/intelai/hailo/yolov8_cls_han.hef"
        self.video_source = "/dev/video2"
    ...
    def get_pipeline_string(self):
        ...
        cls_pipeline = INFERENCE_PIPELINE(
            hef_path=self.hef_path,
            post_process_so="/home/intelai/hailo/hailo-apps-infra/skin_post/build/libskin_post.so",
            post_function_name="yolov8_cls",
            batch_size=1,
        )
...
def main():
    ...
    app = GStreamerYoloApp(app_callback, user_data)
    app.run()
